  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-12">
        ...
        <div class="row shuffle-wrapper shuffle" style="position: relative; overflow: hidden; height: 608px; transition: height 250ms cubic-bezier(0.4, 0, 0.2, 1) 0s;max-height:545px;">
