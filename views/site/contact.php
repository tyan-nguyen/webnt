<div class="container">
    ...
    <div class="row text-center">
      <div class="col-12">
        <h2 class="section-title">Các kênh liên hệ</h2>
        <h3 class="section-sub-title">Liên hệ chúng tôi</h3>
      </div>
    </div>
    <!--/ Title row end -->
      ...
      <div class="col-md-4">
        <div class="ts-service-box-bg text-center h-100">
          ...
          <div class="ts-service-box-content">
            <h4>Văn phòng</h4>
            <p>Đường Nguyễn Đáng, Khóm 10, Phường 9, TP. Trà Vinh</p>
          </div>
        </div>
      </div><!-- Col 1 end -->
