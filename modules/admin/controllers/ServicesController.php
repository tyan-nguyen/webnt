        ...
        if($request->isAjax){
            ...
            return [
                    ...
                    'footer'=> Html::button(Yii::t('app', 'Close'),['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
                            Html::a(Yii::t('app', 'Edit'),['update','id'=>$id],['class'=>'btn btn-primary','role'=>'modal-remote1', 'data-pjax'=>0])
                ];    
        }else{
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> Yii::t('app', 'Create new') . " Services",
    ...
    public function actionUpdate($id, $fromcreate=false)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> Yii::t('app', 'Update'). " Services #".$id,
