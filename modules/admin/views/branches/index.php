...
/* @var $searchModel app\modules\admin\models\BranchesSearch */
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote1', 'data-pjax'=>0, 'title'=> Yii::t('app', 'Create new') . ' Branches','class'=>'btn btn-default']).
...
<div class="modal-dialog1" style="width:900px">
  <div class="modal-content" style="height:700px;">
    ...
    <div class="modal-body">
      <iframe width="850" height="600" src="/filemanager/filemanager/dialog.php?type=2&fldr=_branches&akey=<?= User::hasRole('bientapvien') ? '1fdb7184e697ab9355a3f1438ddc6ef9' : '' ?>" frameborder="0" style="overflow: scroll; overflow-x: hidden; overflow-y: scroll; "></iframe>
    </div>
  </div><!-- /.modal-content -->
</div><!-- /.modal-dialog -->
</div><!-- /.modal -->
