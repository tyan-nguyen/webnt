...
/* @var $searchModel app\modules\admin\models\ShowCasesSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Show Cases');
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="show-cases-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote1', 'data-pjax'=>0, 'title'=> Yii::t('app', 'Create new') . ' Show Cases','class'=>'btn btn-default']).
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Show Cases listing',
...
<div class="modal-dialog1" style="width:900px">
  <div class="modal-content" style="height:700px;">
    ...
    <div class="modal-body">
      <iframe width="850" height="600" src="/filemanager/filemanager/dialog.php?type=2&fldr=_showcases&akey=<?= User::hasRole('bientapvien') ? '1fdb7184e697ab9355a3f1438ddc6ef9' : '' ?>" frameborder="0" style="overflow: scroll; overflow-x: hidden; overflow-y: scroll; "></iframe>
    </div>
  </div><!-- /.modal-content -->
</div><!-- /.modal-dialog -->
</div><!-- /.modal -->
